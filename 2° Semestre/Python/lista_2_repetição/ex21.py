...
# 1° loop para verificar se a pessoa digita 0
while True:
    dinheiro = float(input('Digite o valor a ser sacado, digite 0 para sair do programa: '))

    if dinheiro == 0:
        break
# 2°loop para contar as notas
    while dinheiro > 0:
...
print(f'Você sacou {contador} vezes.')        